...
library Keys {
  ...
  bytes32 public constant MAX_TOTAL_CALLBACK_GAS_LIMIT_FOR_AUTO_CANCEL_ORDERS =
    keccak256(abi.encode('MAX_TOTAL_CALLBACK_GAS_LIMIT_FOR_AUTO_CANCEL_ORDERS'));
  ...
  bytes32 public constant ACCOUNT_GLV_DEPOSIT_LIST =
    keccak256(abi.encode('ACCOUNT_GLV_DEPOSIT_LIST'));
  bytes32 public constant GLV_WITHDRAWAL_LIST = keccak256(abi.encode('GLV_WITHDRAWAL_LIST'));
  bytes32 public constant ACCOUNT_GLV_WITHDRAWAL_LIST =
    keccak256(abi.encode('ACCOUNT_GLV_WITHDRAWAL_LIST'));
  bytes32 public constant GLV_SUPPORTED_MARKET_LIST =
    keccak256(abi.encode('GLV_SUPPORTED_MARKET_LIST'));
  ...
  bytes32 public constant CREATE_GLV_DEPOSIT_FEATURE_DISABLED =
    keccak256(abi.encode('CREATE_GLV_DEPOSIT_FEATURE_DISABLED'));
  bytes32 public constant CANCEL_GLV_DEPOSIT_FEATURE_DISABLED =
    keccak256(abi.encode('CANCEL_GLV_DEPOSIT_FEATURE_DISABLED'));
  bytes32 public constant EXECUTE_GLV_DEPOSIT_FEATURE_DISABLED =
    keccak256(abi.encode('EXECUTE_GLV_DEPOSIT_FEATURE_DISABLED'));

  bytes32 public constant CREATE_GLV_WITHDRAWAL_FEATURE_DISABLED =
    keccak256(abi.encode('CREATE_GLV_WITHDRAWAL_FEATURE_DISABLED'));
  bytes32 public constant CANCEL_GLV_WITHDRAWAL_FEATURE_DISABLED =
    keccak256(abi.encode('CANCEL_GLV_WITHDRAWAL_FEATURE_DISABLED'));
  bytes32 public constant EXECUTE_GLV_WITHDRAWAL_FEATURE_DISABLED =
    keccak256(abi.encode('EXECUTE_GLV_WITHDRAWAL_FEATURE_DISABLED'));

  bytes32 public constant CREATE_GLV_SHIFT_FEATURE_DISABLED =
    keccak256(abi.encode('CREATE_GLV_SHIFT_FEATURE_DISABLED'));
  bytes32 public constant EXECUTE_GLV_SHIFT_FEATURE_DISABLED =
    keccak256(abi.encode('EXECUTE_GLV_SHIFT_FEATURE_DISABLED'));
  ...
  bytes32 public constant EXECUTE_ATOMIC_WITHDRAWAL_FEATURE_DISABLED =
    keccak256(abi.encode('EXECUTE_ATOMIC_WITHDRAWAL_FEATURE_DISABLED'));

  // @dev key for whether the create shift feature is disabled
  bytes32 public constant CREATE_SHIFT_FEATURE_DISABLED =
    keccak256(abi.encode('CREATE_SHIFT_FEATURE_DISABLED'));
  // @dev key for whether the cancel shift feature is disabled
  bytes32 public constant CANCEL_SHIFT_FEATURE_DISABLED =
    keccak256(abi.encode('CANCEL_SHIFT_FEATURE_DISABLED'));
  // @dev key for whether the execute shift feature is disabled
  bytes32 public constant EXECUTE_SHIFT_FEATURE_DISABLED =
    keccak256(abi.encode('EXECUTE_SHIFT_FEATURE_DISABLED'));
  ...
  bytes32 public constant MAX_ORACLE_TIMESTAMP_RANGE =
    keccak256(abi.encode('MAX_ORACLE_TIMESTAMP_RANGE'));
  ...
  bytes32 public constant IS_ORACLE_PROVIDER_ENABLED =
    keccak256(abi.encode('IS_ORACLE_PROVIDER_ENABLED'));
  // @dev key for whether an oracle provider can be used for atomic actions
  bytes32 public constant IS_ATOMIC_ORACLE_PROVIDER =
    keccak256(abi.encode('IS_ATOMIC_ORACLE_PROVIDER'));
  // @dev key for oracle timestamp adjustment
  bytes32 public constant ORACLE_TIMESTAMP_ADJUSTMENT =
    keccak256(abi.encode('ORACLE_TIMESTAMP_ADJUSTMENT'));
  // @dev key for oracle provider for token
  bytes32 public constant ORACLE_PROVIDER_FOR_TOKEN =
    keccak256(abi.encode('ORACLE_PROVIDER_FOR_TOKEN'));
  // @dev key for the chainlink payment token
  bytes32 public constant CHAINLINK_PAYMENT_TOKEN =
    keccak256(abi.encode('CHAINLINK_PAYMENT_TOKEN'));
  // @dev key for the sequencer grace duration
  bytes32 public constant SEQUENCER_GRACE_DURATION =
    keccak256(abi.encode('SEQUENCER_GRACE_DURATION'));
  ...
  bytes32 public constant LIQUIDATION_FEE_RECEIVER_FACTOR =
    keccak256(abi.encode('LIQUIDATION_FEE_RECEIVER_FACTOR'));
  ...
  bytes32 public constant EXECUTION_GAS_FEE_BASE_AMOUNT_V2_1 =
    keccak256(abi.encode('EXECUTION_GAS_FEE_BASE_AMOUNT_V2_1'));
  // @dev key for the gas limit used for each oracle price
  bytes32 public constant EXECUTION_GAS_FEE_PER_ORACLE_PRICE =
    keccak256(abi.encode('EXECUTION_GAS_FEE_PER_ORACLE_PRICE'));
  ...
  bytes32 public constant GLV_WITHDRAWAL_GAS_LIMIT =
    keccak256(abi.encode('GLV_WITHDRAWAL_GAS_LIMIT'));
  bytes32 public constant GLV_SHIFT_GAS_LIMIT = keccak256(abi.encode('GLV_SHIFT_GAS_LIMIT'));
  bytes32 public constant GLV_PER_MARKET_GAS_LIMIT =
    keccak256(abi.encode('GLV_PER_MARKET_GAS_LIMIT'));
  ...
  bytes32 public constant REQUEST_EXPIRATION_TIME =
    keccak256(abi.encode('REQUEST_EXPIRATION_TIME'));

  bytes32 public constant MAX_CALLBACK_GAS_LIMIT = keccak256(abi.encode('MAX_CALLBACK_GAS_LIMIT'));
  bytes32 public constant REFUND_EXECUTION_FEE_GAS_LIMIT =
    keccak256(abi.encode('REFUND_EXECUTION_FEE_GAS_LIMIT'));
  ...
  bytes32 public constant MAX_POOL_USD_FOR_DEPOSIT =
    keccak256(abi.encode('MAX_POOL_USD_FOR_DEPOSIT'));
  ...
  bytes32 public constant IGNORE_OPEN_INTEREST_FOR_USAGE_FACTOR =
    keccak256(abi.encode('IGNORE_OPEN_INTEREST_FOR_USAGE_FACTOR'));
  ...
  bytes32 public constant ABOVE_OPTIMAL_USAGE_BORROWING_FACTOR =
  ...
  bytes32 public constant MIN_AFFILIATE_REWARD_FACTOR =
    keccak256(abi.encode('MIN_AFFILIATE_REWARD_FACTOR'));
  ...
  bytes32 public constant GLV_MAX_MARKET_TOKEN_BALANCE_USD =
    keccak256(abi.encode('GLV_MAX_MARKET_TOKEN_BALANCE_USD'));
  bytes32 public constant GLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT =
    keccak256(abi.encode('GLV_MAX_MARKET_TOKEN_BALANCE_AMOUNT'));
  bytes32 public constant IS_GLV_MARKET_DISABLED = keccak256(abi.encode('IS_GLV_MARKET_DISABLED'));
  bytes32 public constant GLV_SHIFT_MAX_PRICE_IMPACT_FACTOR =
    keccak256(abi.encode('GLV_SHIFT_MAX_PRICE_IMPACT_FACTOR'));
  bytes32 public constant GLV_SHIFT_LAST_EXECUTED_AT =
    keccak256(abi.encode('GLV_SHIFT_LAST_EXECUTED_AT'));
  bytes32 public constant GLV_SHIFT_MIN_INTERVAL = keccak256(abi.encode('GLV_SHIFT_MIN_INTERVAL'));
  bytes32 public constant MIN_GLV_TOKENS_FOR_FIRST_DEPOSIT =
    keccak256(abi.encode('MIN_GLV_TOKENS_FOR_FIRST_DEPOSIT'));

  // @dev key for disabling automatic parameter updates via ConfigSyncer
  bytes32 public constant SYNC_CONFIG_FEATURE_DISABLED =
    keccak256(abi.encode('SYNC_CONFIG_FEATURE_DISABLED'));
  // @dev key for disabling all parameter updates for a specific market via ConfigSyncer
  bytes32 public constant SYNC_CONFIG_MARKET_DISABLED =
    keccak256(abi.encode('SYNC_CONFIG_MARKET_DISABLED'));
  // @dev key for disabling all updates for a specific parameter via ConfigSyncer
  bytes32 public constant SYNC_CONFIG_PARAMETER_DISABLED =
    keccak256(abi.encode('SYNC_CONFIG_PARAMETER_DISABLED'));
  // @dev key for disabling all updates for a specific market parameter via ConfigSyncer
  bytes32 public constant SYNC_CONFIG_MARKET_PARAMETER_DISABLED =
    keccak256(abi.encode('SYNC_CONFIG_MARKET_PARAMETER_DISABLED'));
  // @dev key for tracking which updateIds have already been applied by ConfigSyncer
  bytes32 public constant SYNC_CONFIG_UPDATE_COMPLETED =
    keccak256(abi.encode('SYNC_CONFIG_UPDATE_COMPLETED'));
  // @dev key for the latest updateId that has been applied by ConfigSyncer
  bytes32 public constant SYNC_CONFIG_LATEST_UPDATE_ID =
    keccak256(abi.encode('SYNC_CONFIG_LATEST_UPDATE_ID'));

  // @dev key for the contributor account list
  bytes32 public constant CONTRIBUTOR_ACCOUNT_LIST =
    keccak256(abi.encode('CONTRIBUTOR_ACCOUNT_LIST'));
  ...
  bytes32 public constant CONTRIBUTOR_TOKEN_AMOUNT =
    keccak256(abi.encode('CONTRIBUTOR_TOKEN_AMOUNT'));
  // @dev key for the max total contributor token amount
  bytes32 public constant MAX_TOTAL_CONTRIBUTOR_TOKEN_AMOUNT =
    keccak256(abi.encode('MAX_TOTAL_CONTRIBUTOR_TOKEN_AMOUNT'));
  // @dev key for the contributor token vault
  bytes32 public constant CONTRIBUTOR_TOKEN_VAULT =
    keccak256(abi.encode('CONTRIBUTOR_TOKEN_VAULT'));
  // @dev key for the contributor last payment at
  bytes32 public constant CONTRIBUTOR_LAST_PAYMENT_AT =
    keccak256(abi.encode('CONTRIBUTOR_LAST_PAYMENT_AT'));
  // @dev key for the min contributor payment interval
  bytes32 public constant MIN_CONTRIBUTOR_PAYMENT_INTERVAL =
    keccak256(abi.encode('MIN_CONTRIBUTOR_PAYMENT_INTERVAL'));
  ...
  bytes32 public constant BUYBACK_AVAILABLE_FEE_AMOUNT =
    keccak256(abi.encode('BUYBACK_AVAILABLE_FEE_AMOUNT'));
  ...
  bytes32 public constant BUYBACK_MAX_PRICE_IMPACT_FACTOR =
    keccak256(abi.encode('BUYBACK_MAX_PRICE_IMPACT_FACTOR'));
  ...
  bytes32 public constant WITHDRAWABLE_BUYBACK_TOKEN_AMOUNT =
    keccak256(abi.encode('WITHDRAWABLE_BUYBACK_TOKEN_AMOUNT'));
  ...
  function createGlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CREATE_GLV_DEPOSIT_FEATURE_DISABLED, module));
  }
  ...
  function cancelGlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CANCEL_GLV_DEPOSIT_FEATURE_DISABLED, module));
  }
  ...
  function executeGlvDepositFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(EXECUTE_GLV_DEPOSIT_FEATURE_DISABLED, module));
  }
  ...
  function createGlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CREATE_GLV_WITHDRAWAL_FEATURE_DISABLED, module));
  }
  ...
  function cancelGlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CANCEL_GLV_WITHDRAWAL_FEATURE_DISABLED, module));
  }
  ...
  function executeGlvWithdrawalFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(EXECUTE_GLV_WITHDRAWAL_FEATURE_DISABLED, module));
  }

  function createGlvShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CREATE_GLV_SHIFT_FEATURE_DISABLED, module));
  }

  function executeGlvShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(EXECUTE_GLV_SHIFT_FEATURE_DISABLED, module));
  }
  ...
  function executeAtomicWithdrawalFeatureDisabledKey(
    address module
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(EXECUTE_ATOMIC_WITHDRAWAL_FEATURE_DISABLED, module));
  }
  ...
  function createShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CREATE_SHIFT_FEATURE_DISABLED, module));
  }
  ...
  function cancelShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(CANCEL_SHIFT_FEATURE_DISABLED, module));
  }
  ...
  function executeShiftFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(EXECUTE_SHIFT_FEATURE_DISABLED, module));
  }
  ...
  function oracleTimestampAdjustmentKey(
    address provider,
    address token
  ) internal pure returns (bytes32) {
  ...
  function minCollateralFactorForOpenInterestMultiplierKey(
    ...
    return
      keccak256(abi.encode(MIN_COLLATERAL_FACTOR_FOR_OPEN_INTEREST_MULTIPLIER, market, isLong));
  }
  ...
  function proTraderTierKey(address account) internal pure returns (bytes32) {
    return keccak256(abi.encode(PRO_TRADER_TIER, account));
  }
  ...
  function proDiscountFactorKey(uint256 proTier) internal pure returns (bytes32) {
    return keccak256(abi.encode(PRO_DISCOUNT_FACTOR, proTier));
  }
  ...
  function liquidationFeeFactorKey(address market) internal pure returns (bytes32) {
    return keccak256(abi.encode(LIQUIDATION_FEE_FACTOR, market));
  }
  ...
  function atomicSwapFeeFactorKey(address market) internal pure returns (bytes32) {
    return keccak256(abi.encode(ATOMIC_SWAP_FEE_FACTOR, market));
  }

  function depositFeeFactorKey(
    address market,
    bool forPositiveImpact
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(DEPOSIT_FEE_FACTOR, market, forPositiveImpact));
  }

  function withdrawalFeeFactorKey(
    address market,
    bool forPositiveImpact
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(WITHDRAWAL_FEE_FACTOR, market, forPositiveImpact));
  }
  ...
  function maxPoolUsdForDepositKey(address market, address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(MAX_POOL_USD_FOR_DEPOSIT, market, token));
  }
  ...
  function latestAdlAtKey(address market, bool isLong) internal pure returns (bytes32) {
    return keccak256(abi.encode(LATEST_ADL_AT, market, isLong));
  }
  ...
  function claimableFundingAmountPerSizeKey(
    ...
    return
      keccak256(abi.encode(CLAIMABLE_FUNDING_AMOUNT_PER_SIZE, market, collateralToken, isLong));
  }
  ...
  function optimalUsageFactorKey(address market, bool isLong) internal pure returns (bytes32) {
    return keccak256(abi.encode(OPTIMAL_USAGE_FACTOR, market, isLong));
  }
  ...
  function baseBorrowingFactorKey(address market, bool isLong) internal pure returns (bytes32) {
    return keccak256(abi.encode(BASE_BORROWING_FACTOR, market, isLong));
  }
  ...
  function aboveOptimalUsageBorrowingFactorKey(
    address market,
    bool isLong
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(ABOVE_OPTIMAL_USAGE_BORROWING_FACTOR, market, isLong));
  }
  ...
  function minAffiliateRewardFactorKey(uint256 referralTierLevel) internal pure returns (bytes32) {
    return keccak256(abi.encode(MIN_AFFILIATE_REWARD_FACTOR, referralTierLevel));
  }
  ...
  function maxAllowedSubaccountActionCountKey(
    ...
    return
      keccak256(abi.encode(MAX_ALLOWED_SUBACCOUNT_ACTION_COUNT, account, subaccount, actionType));
  }
  ...
  function dataStreamMultiplierKey(address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(DATA_STREAM_MULTIPLIER, token));
  }
  ...
  function glvMaxMarketTokenBalanceUsdKey(
    address glv,
    address market
  ) internal pure returns (bytes32) {
  ...
  // it is used to limit amount of funds deposited into each market
  function glvMaxMarketTokenBalanceAmountKey(
    address glv,
    address market
  ) internal pure returns (bytes32) {
  ...
  function glvShiftMaxPriceImpactFactorKey(address glv) internal pure returns (bytes32) {
    return keccak256(abi.encode(GLV_SHIFT_MAX_PRICE_IMPACT_FACTOR, glv));
  }
  ...
  function glvShiftLastExecutedAtKey(address glv) internal pure returns (bytes32) {
    return keccak256(abi.encode(GLV_SHIFT_LAST_EXECUTED_AT, glv));
  }
  ...
  function glvShiftMinIntervalKey(address glv) internal pure returns (bytes32) {
    return keccak256(abi.encode(GLV_SHIFT_MIN_INTERVAL, glv));
  }

  function minGlvTokensForFirstGlvDepositKey(address glv) internal pure returns (bytes32) {
    return keccak256(abi.encode(MIN_GLV_TOKENS_FOR_FIRST_DEPOSIT, glv));
  }
  ...
  function syncConfigFeatureDisabledKey(address module) internal pure returns (bytes32) {
    return keccak256(abi.encode(SYNC_CONFIG_FEATURE_DISABLED, module));
  }
  ...
  function syncConfigMarketDisabledKey(address market) internal pure returns (bytes32) {
    return keccak256(abi.encode(SYNC_CONFIG_MARKET_DISABLED, market));
  }
  ...
  function syncConfigParameterDisabledKey(string memory parameter) internal pure returns (bytes32) {
    return keccak256(abi.encode(SYNC_CONFIG_PARAMETER_DISABLED, parameter));
  }
  ...
  function syncConfigMarketParameterDisabledKey(
    address market,
    string memory parameter
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(SYNC_CONFIG_MARKET_PARAMETER_DISABLED, market, parameter));
  }
  ...
  function syncConfigUpdateCompletedKey(uint256 updateId) internal pure returns (bytes32) {
    return keccak256(abi.encode(SYNC_CONFIG_UPDATE_COMPLETED, updateId));
  }
  ...
  function contributorTokenAmountKey(
    ...
    return keccak256(abi.encode(CONTRIBUTOR_TOKEN_AMOUNT, account, token));
  }
  ...
  function maxTotalContributorTokenAmountKey(address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(MAX_TOTAL_CONTRIBUTOR_TOKEN_AMOUNT, token));
  }
  ...
  function contributorTokenVaultKey(address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(CONTRIBUTOR_TOKEN_VAULT, token));
  }
  ...
  function buybackBatchAmountKey(address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(BUYBACK_BATCH_AMOUNT, token));
  }
  ...
  function buybackAvailableFeeAmountKey(
    address feeToken,
    address swapToken
  ) internal pure returns (bytes32) {
    return keccak256(abi.encode(BUYBACK_AVAILABLE_FEE_AMOUNT, feeToken, swapToken));
  }
  ...
  function withdrawableBuybackTokenAmountKey(address buybackToken) internal pure returns (bytes32) {
    return keccak256(abi.encode(WITHDRAWABLE_BUYBACK_TOKEN_AMOUNT, buybackToken));
  }
  ...
  function buybackGmxFactorKey(uint256 version) internal pure returns (bytes32) {
    return keccak256(abi.encode(BUYBACK_GMX_FACTOR, version));
  }
  ...
  function buybackMaxPriceImpactFactorKey(address token) internal pure returns (bytes32) {
    return keccak256(abi.encode(BUYBACK_MAX_PRICE_IMPACT_FACTOR, token));
  }
}
